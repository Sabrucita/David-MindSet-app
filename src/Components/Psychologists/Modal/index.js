  ...
  if (!props.show) {
    ...
    return (
      <div className={styles.modal}>
        <div className={styles.centerModal}>
          <h3 className={styles.modalMessage}>Are you sure you want to delete this psycho?</h3>
    ...
    return (
      <div className={styles.modal}>
        <div className={styles.centerModal}>
          <div className={styles.modalMessage}>
            <h3 className={styles.modalMessage}>Your psychologist has been updated succesfully</h3>
          </div>
          <div className={styles.buttonModal}>
    ...
    return (
      <div className={styles.modal}>
        <div className={styles.centerModal}>
          <div className={styles.modalMessage}>
            <h3 className={styles.modalMessage}>Your psychologist has been created succesfully</h3>
          </div>
          <div className={styles.buttonModal}>
            <button className={styles.modalCancel} onClick={onUpdModal}>
              RETURN TO HOMEPAGE
